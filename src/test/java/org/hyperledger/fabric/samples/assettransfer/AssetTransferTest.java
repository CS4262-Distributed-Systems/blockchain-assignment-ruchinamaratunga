...
public final class AssetTransferTest {
    ...
    class DuplicateAssetTransaction {
        ...
        public void whenAssetExists() {
            ...
            Asset asset = contract.DuplicateAsset(ctx, "asset1", "Dr Strange");

            assertThat(asset).isEqualTo(new Asset("asset1", "blue", 5, "Dr Strange", 300));
        }
        ...
        public void whenAssetDoesNotExist() {
            ...
            Throwable thrown = catchThrowable(() -> {
                contract.DuplicateAsset(ctx, "asset1", "Dr Strange");
            });
